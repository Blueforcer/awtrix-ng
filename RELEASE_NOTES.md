...
- **Install firmware updates from the web UI.** Choose **Download & install** and confirm. Your browser downloads and verifies the correct image, then uploads it to AWTRIX with progress shown throughout. Settings and files are kept.
