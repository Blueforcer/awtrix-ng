...
bool draw(Canvas& canvas, const std::string& iconId, int x, int y, bool* outOfMemory) {
  ...
  std::string path;
  // Same convention as GifPlayer: a base64: prefix marks the string as inline image data;
  // a name longer than any legal icon id falls back to the legacy length heuristic.
