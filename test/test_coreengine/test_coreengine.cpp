...
static void test_the_hidden_list_decides_what_stays_out() {
  FSound so; FDisplay di; FSystem sy;
  CoreEngine e(so, di, sy);
  TEST_ASSERT_EQUAL_INT(rc(DispatchResult::Ok),
      rc(e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Humidity\",\"Time\"],\"hidden\":[\"Date\",\"Temperature\",\"Battery\"]}"))));
...
static void test_an_app_that_turns_up_later_joins_the_loop() {
  FSound so; FDisplay di; FSystem sy;
  CoreEngine e(so, di, sy);
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\"],\"hidden\":[\"Date\",\"Temperature\",\"Humidity\",\"Battery\"]}"));
  ...
  TEST_ASSERT_EQUAL_INT(rc(DispatchResult::Ok),
      rc(e.execute(cmd(CommandType::SetAppOrder, "",
                       "{\"order\":[\"Temperature\",\"Time\",\"weather\"],\"hidden\":[\"Date\",\"Humidity\",\"Battery\"]}"))));
...
static void test_order_allows_duplicate_apps() {
  ...
  TEST_ASSERT_EQUAL_INT(rc(DispatchResult::Ok),
      rc(e.execute(cmd(CommandType::SetAppOrder, "",
                       "{\"order\":[\"Time\",\"Temperature\",\"Time\",\"Humidity\"],\"hidden\":[\"Date\",\"Battery\"]}"))));
...
static void test_order_reserves_spot_for_unknown_apps() {
  ...
  TEST_ASSERT_EQUAL_INT(rc(DispatchResult::Ok),
      rc(e.execute(cmd(CommandType::SetAppOrder, "",
                       "{\"order\":[\"Time\",\"weather\",\"Temperature\"],\"hidden\":[\"Date\",\"Humidity\",\"Battery\"]}"))));
  TEST_ASSERT_EQUAL_UINT(2u, (unsigned)e.appHost().count());
  TEST_ASSERT_EQUAL_STRING("Time", e.appHost().ids()[0].c_str());
...
static void test_apps_inventory_includes_hidden() {
  FSound so; FDisplay di; FSystem sy;
  CoreEngine e(so, di, sy);
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\"],\"hidden\":[\"Date\",\"ghost\"]}"));
...
static void test_per_app_duration_overrides_global() {
  ...
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"fast\",\"Time\"],\"hidden\":[\"Date\",\"Temperature\",\"Humidity\",\"Battery\"]}"));
...
static void test_frequent_pushes_do_not_freeze_the_rotation() {
  ...
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\",\"weather\"],\"hidden\":[\"Date\",\"Temperature\",\"Humidity\",\"Battery\"]}"));
...
static void test_settings_change_leaves_loop_alone() {
  ...
  CoreEngine e(so, di, sy);
  TEST_ASSERT_EQUAL_INT(rc(DispatchResult::Ok),
      rc(e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\",\"Date\"],\"hidden\":[\"Temperature\",\"Humidity\",\"Battery\"]}"))));
  TEST_ASSERT_EQUAL_INT(rc(DispatchResult::Ok),
...
static void test_script_app_declining_is_skipped_by_the_rotation() {
  ...
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\",\"Silent\",\"Loud\"],\"hidden\":[\"Date\",\"Temperature\",\"Humidity\",\"Battery\"]}"));
  TEST_ASSERT_EQUAL_STRING("Time", e.currentAppId().c_str());
...
static void test_script_app_duration_overrides_global() {
  ...
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Quick\",\"Time\"],\"hidden\":[\"Date\",\"Temperature\",\"Humidity\",\"Battery\"]}"));
...
static void test_script_pause_holds_rotation_until_a_manual_move() {
  ...
  CoreEngine e(so, di, sy);
  e.execute(cmd(CommandType::SetSettings, "", "{\"transitionDurationMs\":400}"));
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\",\"Date\"],\"hidden\":[\"Temperature\",\"Humidity\",\"Battery\"]}"));
  e.tick(0);
  TEST_ASSERT_EQUAL_STRING("Time", e.currentAppId().c_str());
...
static void test_the_app_order_switches_a_headless_script_on_and_off() {
  ...
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\",\"Doorbell\"],\"hidden\":[\"Date\",\"Temperature\",\"Humidity\",\"Battery\"]}"));
  TEST_ASSERT_TRUE(e.isEnabled("Doorbell"));
  TEST_ASSERT_TRUE(scripts.runs("Doorbell"));
  TEST_ASSERT_FALSE(e.isInLoop("Doorbell"));
  ...
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\"],\"hidden\":[\"Date\",\"Temperature\",\"Humidity\",\"Battery\",\"Doorbell\"]}"));
...
static void test_a_disabled_pushed_app_stays_disabled_across_a_reboot() {
  ...
  e.execute(cmd(CommandType::SetAppOrder, "",
                "{\"order\":[\"Time\",\"Date\",\"Temperature\",\"Humidity\",\"Battery\"],\"hidden\":[\"wetter\"]}"));
...
static void test_an_explicit_hidden_list_leaves_unmentioned_apps_alone() {
  FSound so; FDisplay di; FSystem sy;
  CoreEngine e(so, di, sy);
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\"],\"hidden\":[\"Date\"]}"));
...
static void test_the_apps_inventory_keeps_a_disabled_app_that_is_gone() {
  ...
  CoreEngine e(so, di, sy);
  e.execute(cmd(CommandType::SetPushedApp, "wetter", "{\"text\":\"x\"}"));
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\"],\"hidden\":[\"wetter\"]}"));
...
static void test_hidden_alone_disables_without_resending_the_order() {
  FSound so; FDisplay di; FSystem sy;
  CoreEngine e(so, di, sy);
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Battery\",\"Time\",\"Date\"],\"hidden\":[\"Temperature\",\"Humidity\"]}"));
  TEST_ASSERT_EQUAL_UINT(3u, (unsigned)e.appHost().count());

  TEST_ASSERT_EQUAL_INT(rc(DispatchResult::Ok),
                        rc(e.execute(cmd(CommandType::SetAppOrder, "", "{\"hidden\":[\"Date\"]}"))));
  TEST_ASSERT_FALSE(e.isEnabled("Date"));
  TEST_ASSERT_TRUE(e.isEnabled("Temperature"));
...
static void test_a_reserved_slot_is_listed_while_its_app_is_away() {
  FSound so; FDisplay di; FSystem sy;
  CoreEngine e(so, di, sy);
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\",\"wetter\"],\"hidden\":[]}"));
...
static void test_deleting_a_script_takes_its_name_out_of_the_arrangement() {
  ...
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\",\"Nightmode\"],\"hidden\":[]}"));
...
static void test_a_deleted_pushed_app_keeps_the_slot_it_was_given() {
  ...
  CoreEngine e(so, di, sy);
  e.execute(cmd(CommandType::SetPushedApp, "wetter", "{\"text\":\"21\"}"));
  e.execute(cmd(CommandType::SetAppOrder, "", "{\"order\":[\"Time\",\"wetter\",\"Date\"],\"hidden\":[]}"));
  e.execute(cmd(CommandType::SetPushedApp, "wetter", "", 0, true));
...
static void test_a_body_the_engine_cannot_read_leaves_the_arrangement_alone() {
  ...
  CoreEngine e(so, di, sy);
  e.execute(cmd(CommandType::SetAppOrder, "",
                "{\"order\":[\"Battery\",\"Time\"],\"hidden\":[\"Date\"]}"));
  TEST_ASSERT_EQUAL_STRING("Battery", e.appHost().ids()[0].c_str());

  const char* bad[] = {
      "{\"order\":[\"Time\"]}",
      "[\"Time\",\"Date\"]",
      "{\"order\":[{\"name\":\"Time\",\"show\":false}],\"hidden\":[]}",
      "{\"order\":\"Time\",\"hidden\":[]}",
      "{\"nope\":[]}",
  };
...
int main(int, char**) {
  ...
  RUN_TEST(test_hidden_alone_disables_without_resending_the_order);
  ...
  RUN_TEST(test_an_explicit_hidden_list_leaves_unmentioned_apps_alone);
  ...
  RUN_TEST(test_the_hidden_list_decides_what_stays_out);
  ...
  RUN_TEST(test_apps_inventory_includes_hidden);
